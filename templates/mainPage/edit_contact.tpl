<div class="modal fade" id="editContact" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form class="form-horizontal" data-toggle="validator" role="form" action="{$conf->action_root}editContact" method="post"> 
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-primary" name="edit-contact" id="edit-contact" value="" disabled>Zapisz kontakt</button>
                </div>
            </form>
